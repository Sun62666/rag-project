...
class Config(BaseSettings):
    ...
    OLLAMA_URL: str = Field(default="http://localhost:11434",description="OLLAMA 嵌入模型base_url")
    ...
    EMBED_MODEL: str = Field(default="nomic-embed-text", description="Embedding模型名称")
    ...
    USE_AGENT: str = Field(default="multi_agent", description="对话模式: graph / agent / multi_agent")
